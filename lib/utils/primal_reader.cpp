...
namespace utils{
  ...
  void PrimalReader::readProblem(const std::string path_to_primal_problem, const int problem_num){
  ...
  std::vector<int> PrimalReader::convertStringToVector(const std::string vector_string){
