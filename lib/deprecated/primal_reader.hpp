...
public:
  ...
  /**
   * @brief reads the nth problem in the simplex problem file and writes
   * formatted contents to class members problem_matrix_.
   *
   * @param path_to_primal_problem full path to text file containing primal
   * problem
   * @param problem_number number of problem in the file
   */
  void readProblem(const std::string path_to_primal_problem,
