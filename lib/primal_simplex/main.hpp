...
namespace primal_simplex{
  ...
  private:
    ...
    /**
     * @brief returns the index of the smallest nonbasic entry in the objective function
     * (first row of table_)
     * 
     * @return int 
     */
    ...
    /**
     * @brief returns index of pivot row in table_ based on the minimum value found 
     * during ratio testing
     * 
     * @param pivot_column_index index found previously in getPivotColumnIndex() funtion
     * @return int 
     */
    ...
    /**
     * @brief constructs new table_ object, completing row operations to reduce required
     * variable to basic
     * 
     ...
     * Solution is optimal if all elements of objective funciton (first row of table_) are 
     * all positive.
     * 
     * @return true 
     * @return false 
